...
This module provides enhanced logging capabilities with ANSI color formatting support, rotating file handlers, and
highlighted logging methods for better console output visibility.
"""
...
def ansi_format(
    text: str = "", color: ANSIEscapeCode = ANSIEscapeCode.BLUE, bold: bool = True, underline: bool = False
) -> str:
...
class LogLevel(Enum):
    ...
    This enum defines the available log levels that can be used with the highlight method of THCLogger for colored
    console output.
    """
